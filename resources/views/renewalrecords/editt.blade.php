    ...
    <div class="row">
      ...
      <div class="row">
        <div class="col-10 offset-1">
		   ...
		   {!! Form::open(['action' => array('RenewalRecordController@update', $app->id),'method'=>'PUT']) !!}
					<div class="form-row">
						<div class="form-group col-md-12">
						  <label for="inputEmail4">Fleet *</label>
						  {{ Form::select('fleetid',$fleet,$app->fleet->id,array('class' => 'input-md form-control', 'required', 'placeholder'=>'Enter renewal name ')) }} 
						</div>
					 </div> 
					<div class="form-row">
						<div class="form-group col-md-6">
						  <label for="inputEmail4">Renewal Type</label>
						  {{ Form::select('renewal',$renew,$app->renewmaster->id,array('class' => 'input-md form-control','placeholder'=>'Enter renewal type', 'required')) }} 
						</div>	
						<div class="form-group col-md-6">
