      ...
      <div class="row">
        <div class="col-8 offset-2">
			<div class="card col-md-8 offset-2">
				<div class="card-header"><h4 class="text-center">Department Profile</h4></div>
            ...
            <div class="form-row">
              <div class="col-md-12">
                <label for="exampleInputLastName">Company Name *</label>
               	...
               	{{ Form::text('compName',$comp->company->name.' '.$comp->company->location,array('class' => 'input-md form-control','required', 'placeholder'=>'Select a company')) }} 
              </div>
            </div>
          </div>			  
