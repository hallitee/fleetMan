...
<body>
Dear Mr. {{ ucfirst(explode('.',$email)[0]) }}
<br>
<br>
Please find below IT Form request for your approval, 
<br>
<br>
<br>
<table class="table1">
...
<br>
<br>
Please click the link below to either approve or dismiss. 
<a href="{{url('/appr').'?id='.$form->id.'&email='.$email}}"> Request Approval </a>
<br>
<br>
<br>
IT Department
