...
<body>
Dear  {{ ucfirst(explode('.',$email)[0]) }},
<br>
<br>
Please find below approved IT Form request for your action, 
<br>
<br>
<br>
<table class="table1">
...
<br>
<br>
Please click the link below when request has been created.
<a href="{{url('/completed?id='.$form->id) }}"> Completed</a>
<br>
<br>
<br>
IT Department
