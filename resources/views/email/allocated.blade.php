...
<br>
<br>
Your @if($form->gaRemark=='URGENT') urgent @endif car request has been allocated, please find your trip information below.
...
<thead>
<tr>
	<th colspan='4' class="text-center"><div class="h5">@if($form->gaRemark=='URGENT') Urgent @endif Trip Information</div> </th>
</tr>
</thead>
